...
public class NumberPickerView extends View {
    ...
    private void initHandler() {
        ...
        mHandlerInMainThread = new MyHandler(new WeakReference<>(this));
    }

    private static class MyHandler extends Handler {
        private WeakReference<NumberPickerView> viewWeak;

        MyHandler(WeakReference<NumberPickerView> viewWeak) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case HANDLER_WHAT_REQUEST_LAYOUT:
                    NumberPickerView npv = viewWeak.get();
                    if (npv != null) {
                        npv.requestLayout();
                    }
                    break;
                case HANDLER_WHAT_LISTENER_VALUE_CHANGED:
                    NumberPickerView npv2 = viewWeak.get();
                    if (npv2 != null) {
                        npv2.respondPickedValueChanged(msg.arg1, msg.arg2, msg.obj);
                    }
                    break;
            }
        }
    ...
    private void scrollByIndexSmoothly(int deltaIndex, boolean needRespond) {
        ...
        if (needRespond) {
            ...
            mHandlerInNewThread.sendMessageDelayed(getMsg(HANDLER_WHAT_REFRESH, 0, 0, needRespond), duration / 4);
        }
        postInvalidate();
    }
