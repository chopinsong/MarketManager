package com.chopin.marketmanager.util.color;/*
...
import com.chopin.marketmanager.util.color.MedianCutQuantizer.ColorNode;
...
public class DominantColorCalculator {
    ...
    private ColorNode findSecondaryAccentColor(final ColorNode primary) {
        ...
        return mWeightedPalette[mWeightedPalette.length > 1 ? 1 : 0];
    }
    ...
    private int findPrimaryTextColor(final ColorNode primary) {
        ...
        // brightness
        return ColorUtils.calculateYiqLuma(primary.getRgb()) >= 200 ? Color.BLACK : Color.WHITE;
    }
